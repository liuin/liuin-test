...
import LiuinTest from '../lib/liuin-test';
...
describe('LiuinTest', () => {
  ...
  beforeEach(() => {
    ...
    activationPromise = atom.packages.activatePackage('liuin-test');
  });

  describe('when the liuin-test:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      // Before the activation event the view is not on the DOM, and no panel
      // has been created
      expect(workspaceElement.querySelector('.liuin-test')).not.toExist();
